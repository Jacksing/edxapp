...
# add jacksing 2015-03-20 start
#####################################################################
# Enable smarteredu
MAKO_TEMPLATES['main'] = \
    [
        COMMON_ROOT / 'smartERproject/templates/common',
        COMMON_ROOT / 'smartERproject/templates/lms',
    ] + MAKO_TEMPLATES['main']
...
STATICFILES_DIRS = \
    [
        COMMON_ROOT / 'smartERproject/static/common',
        COMMON_ROOT / 'smartERproject/static_lms',
    ] + STATICFILES_DIRS

AUTHENTICATION_BACKENDS = \
    (
        'smarteredu.appauth.backends.OpenIDBackend',
        'smarteredu.appauth.backends.TesterBackend',
    ) + AUTHENTICATION_BACKENDS

TESTER_ACCOUNT = ['guojiayu@yahoo.com', 'johnpub2000@gmail.com', 'johnpub2000@yahoo.com']
...
PIPELINE_CSS.update({
    'style-smarteredu-devstack': {
        'source_filenames': [
            'css/secss.css',
            'css/smrtedu.css',
        ],
        'output_filename': 'css/lms-style-smarteredu-devstack.css',
    },
    'style-smarteredu': {
        'source_filenames': [
            'sass/smarteredu-extend.css',
        ],
        'output_filename': 'css/lms-style-smarteredu.css',
    },
    # this is new lms style 2015-07-21
    'style-smarteredu-base': {
        'source_filenames': [
            'sass/base/effects.css',
            'sass/base/falsework.css',
            'sass/base/fonts.css',
            'sass/base/landing.css',
            'sass/base/footer.css',
            'sass/components/buttons.css',
            'sass/components/unit.css',
            'sass/smarteredu-base.css',
            'css/font-awesome.css',
        ],
        'output_filename': 'css/lms-stl-se-bas.css',
    },
    'style-smarteredu-overrides': {
        'source_filenames': [
            'sass/smarteredu-overrides.css',
        ],
        'output_filename': 'css/lms-stl-se-ovr.css',
    },
    'style-smarteredu-index': {
        'source_filenames': [
            'sass/smarteredu-index.css',
        ],
        'output_filename': 'css/lms-stl-se-idx.css',
    },
    'style-smarteredu-search': {
        'source_filenames': [
            'sass/smarteredu-search.css',
        ],
        'output_filename': 'css/lms-stl-se-srh.css',
    },
    'style-smarteredu-auth': {
        'source_filenames': [
            'sass/smarteredu-auth.css',
            'sass/components/faq.css',
        ],
        'output_filename': 'css/lms-stl-se-ath.css',
    },
    'style-smarteredu-view': {
        'source_filenames': [
            'sass/smarteredu-view.css',
            'sass/multicourse/enrollment.css',
        ],
        'output_filename': 'css/lms-stl-se-view.css',
    },
    'style-smarteredu-static': {
        'source_filenames': [
            'sass/components/faq.css',
            'sass/community/resources.css',
            'sass/community/latest-news.css',
        ],
        'output_filename': 'css/lms-stl-se-stc.css',
    }
})
...
PIPELINE_JS.update({
    'smarteredu': {
        'source_filenames': [
            'js/smarteredu_basic.js',
        ],
        'output_filename': 'js/lms-se-bas.js'
    },
#    'third-party-login': {
#        'source_filenames': [
#            'js/third-party-login.js'
#        ],
#        'output_filename': 'js/third-party-login.js'
#    },
    'search_board': {
        'source_filenames': [
            'js/search_util.js',
            'js/search_board_ready.js',
        ],
        'output_filename': 'js/lms-se-srh.js'
    },
})

sys.path.append(COMMON_ROOT / 'smartERproject')

INSTALLED_APPS += (
    # SmarterEdu(smartERproject)
    'smarteredu.common',
    'smarteredu.appauth',
    'smarteredu.course',
    'smarteredu.institution',
    'smarteredu.teacher',
    'smarteredu.snatcher',
    'paypal.standard.ipn',
)

STUDIO_URL = ENV_TOKENS.get('STUDIO_URL', '0.0.0.0:8001')

MKTG_URL_LINK_MAP['COPYRIGHT'] = 'copyright'
MKTG_URL_LINK_MAP['AGREEMENT'] = 'agreement'

#PAYPAL_RECEIVER_EMAIL = "pangyan-facilitator-1@gmail.com"
PAYPAL_RECEIVER_EMAIL = 'pangyan@gmail.com'
PAYPAL_TEST = False
# add jacksing 2015-04-07 end
